...
//repository sorting : https://github.com/arifwidiasan/Sorting-struct-c (project ini)
...
int main() {
	...
	if(pilih==1){
		...
		printf("\nData berhasil diurutkan berdasarkan NPM !, silakan pilih menu tampil data untuk melihat hasilnya");
		getch();
		system("cls");
		goto awal;
	}else if(pilih==6){
